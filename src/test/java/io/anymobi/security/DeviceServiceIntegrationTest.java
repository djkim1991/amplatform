...
import io.anymobi.domain.entity.sec.DeviceMetadata;
import io.anymobi.domain.entity.users.User;
import io.anymobi.repositories.jpa.security.DeviceMetadataRepository;
...
@SpringBootTest(classes = {AMPApplication.class, TestIntegrationConfig.class}, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
